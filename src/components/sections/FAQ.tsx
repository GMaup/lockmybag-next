...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="scroll-mt-28 py-16 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          {faqs.map((faq, index) => (
            <div key={index} className="mb-4">
              <button
                className="w-full text-left p-6 bg-surface-light hover:bg-surface rounded-lg transition-colors duration-200"
        ...
        <div className="mt-12 text-center bg-surface-primary rounded-2xl p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:contact@lockmybag.fr" className="inline-flex items-center justify-center px-6 py-3 bg-brand-primary text-brand-primary-foreground rounded-lg hover:bg-brand-primary-hover transition-colors">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              contact@lockmybag.fr
            </a>
            <a href="tel:+33600000000" className="inline-flex items-center justify-center px-6 py-3 bg-brand-secondary text-brand-secondary-foreground rounded-lg hover:bg-brand-secondary-hover transition-colors">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
